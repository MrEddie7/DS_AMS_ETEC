...
INSERT into categoria (Cod_categoria,Nome_categoria,descricao) 
VALUES (4,'Dairy Products','Cheses');
...
Update Categoria set Descricao = 'Queijos' where Descricao like 'Cheses';
...
Update Envio set Cidade = 'Leao' where Cidade like 'lyon';
Update Envio set Pais = 'Suécia' where Pais like 'Switzerland';
Update Envio set Regiao = null;
...
Update Departamento set NomeDep = 'TI' where CodFunc = 1;
Update Departamento set CodFunc = 10 where NomeDep = 'Transporte';
Update Departamento set NomeDep = 'Desenvolvimento' where NomeDep = 'recursos Humanos';
...
DELETE from Envio where NomeNavio like 'Chop'
SELECT * from Envio;
